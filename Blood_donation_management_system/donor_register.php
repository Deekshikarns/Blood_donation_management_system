<?php
      ...
      if(isset($_POST["submit"]))
	{
      ...
      if($ques2=="Yes"){
        echo "<script type='text/javascript'>alert('sorry you cannot donate blood if you are having illness')</script>";
      }else if($ques3=="Yes"){
        echo  "<script type='text/javascript'>alert('sorry you cannot donate blood if you are having allergy')</script>";
      }
      else if($age<18 ){
        echo  "<script type='text/javascript'>alert('sorry you cannot donate blood to donate blood u should above 18 ')</script>";
      }
      else{
  
        $query="INSERT INTO donor_register(firstname, lastname, age,dob, email, num, area,district,state, blood, ques1 , ques2 , ques3) VALUES('$firstname', '$lastname', '$age' , '$date', '$email', '$num', '$area', '$district','$state','$blood', '$ques1','$ques2','$ques3')";
...
<body>
    <form  method="POST">
        <div class="register">
            ...
            <h1>  <i class='bx bx-arrow-back' onclick="window.location.href='home.php'"></i>&nbsp;&nbsp; Donor Information</h1><br><br>
